...
var ReadingService = _interopRequireWildcard(require("../services/reading.service"));
...
var getAllReadings = /*#__PURE__*/function () {
  ...
  return function getAllReadings(_x, _x2, _x3) {
...
var getLineChartData = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return ReadingService.getLineChartData(req.params._id, req.query.sensor);
          case 3:
            data = _context2.sent;
            res.status(_httpStatusCodes["default"].OK).json({
              code: _httpStatusCodes["default"].OK,
  ...
  return function getLineChartData(_x4, _x5, _x6) {
...
var getReading = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return ReadingService.getReading(req.params._id);
          case 3:
            data = _context3.sent;
            res.status(_httpStatusCodes["default"].OK).json({
              code: _httpStatusCodes["default"].OK,
  ...
  return function getReading(_x7, _x8, _x9) {
...
var newReading = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return ReadingService.newReading(req.body);
          case 3:
            data = _context4.sent;
  ...
  return function newReading(_x10, _x11, _x12) {
...
var updateReading = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return ReadingService.updateReading(req.params._id, req.body);
          case 3:
            data = _context5.sent;
  ...
  return function updateReading(_x13, _x14, _x15) {
...
var deleteReading = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.prev = 0;
            _context6.next = 3;
            return ReadingService.deleteReading(req.params._id);
          case 3:
            res.status(_httpStatusCodes["default"].OK).json({
              code: _httpStatusCodes["default"].OK,
              data: [],
  ...
  return function deleteReading(_x16, _x17, _x18) {
