...
var SensorService = _interopRequireWildcard(require("../services/sensor.service"));
...
var getAllSensors = /*#__PURE__*/function () {
  ...
  return function getAllSensors(_x, _x2, _x3) {
...
var getSensor = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return SensorService.getSensor(req.params._id);
          case 3:
            data = _context2.sent;
            res.status(_httpStatusCodes["default"].OK).json({
              code: _httpStatusCodes["default"].OK,
  ...
  return function getSensor(_x4, _x5, _x6) {
...
var newSensor = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return SensorService.newSensor(req.body);
          case 3:
            data = _context3.sent;
  ...
  return function newSensor(_x7, _x8, _x9) {
...
var updateSensor = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return SensorService.updateSensor(req.params._id, req.body);
          case 3:
            data = _context4.sent;
  ...
  return function updateSensor(_x10, _x11, _x12) {
...
var deleteSensor = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return SensorService.deleteSensor(req.params._id);
          case 3:
            res.status(_httpStatusCodes["default"].OK).json({
              code: _httpStatusCodes["default"].OK,
              data: [],
  ...
  return function deleteSensor(_x13, _x14, _x15) {
