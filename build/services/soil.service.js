...
var _soil = _interopRequireDefault(require("../models/soil.model"));
//get all soils
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _soil["default"].create(body);
          case 2:
            data = _context2.sent;
...
var updateSoil = /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _soil["default"].findByIdAndUpdate({
              _id: _id
            }, body, {
              "new": true
            });
  ...
  return function updateSoil(_x2, _x3) {
...
var deleteSoil = /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return _soil["default"].findByIdAndDelete(id);
          case 2:
  ...
  return function deleteSoil(_x4) {
    ...
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return _soil["default"].findById(id);
          case 2:
            data = _context5.sent;
